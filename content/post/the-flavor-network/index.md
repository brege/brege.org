...
Search is not sorted by the flavor metric, rather, [lexically](https://fusejs.io/) instead.
...
Reconstructing 'ghost' entries and connections by training a model with listed affinities is the ultimate agenda.
...
In 2019, I was helping fellow chefs come up with new farm-to-fork specials. Sometimes, you get stuck coming up with something. What do you do?  A good trick, at least for creativity, is to set rules so you have some boundaries to push. Naturally, the prompts became:
1. do something new
2. use something old
3. feature three things in season

We would work out new ideas together over the prep table.
As ideas began to stretch with supply and the Northern California winter approached, we sometimes used sheets of butcher paper to draw out a crude graph of our plate setups.
These were sketches of sauce and protein layouts, heavy edges between ideas if their pairing 'sang', now a guide hanging from the ticket rail on the night a feature debuted.
...
Wouldn't it be nice to be able to manipulate a canvas, like a musician can with a guitar or an artist can with photoshop, without ever getting your hands dirty: from the sofa, with a good glass of wine.
